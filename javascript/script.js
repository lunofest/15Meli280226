...
function updateTimer() {
  const targetDate = new Date("february 28, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543885893150'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543885893150'; // Número para el primer botón
